    ...
    async def dispatch(self, request: Request, call_next):
        ...
        try:
            ...
            if path.endswith("/notifications/send"):
                logging.info(f"Notification processed: {method} {path} processed", extra=extra)
            elif path.endswith("/notifications/retry"):
                logging.info(f"Notification retry requested: {method} {path} processed", extra=extra)
            else:
