...
app.add_middleware(LoggingAndMetricsMiddleware, service_name="payment-service")

# Mount routes
app.include_router(payments.router, prefix="/api/v1/payments", tags=["User Payment APIs"])
app.include_router(admin.router, prefix="/api/v1/admin", tags=["Admin Payment APIs"])
